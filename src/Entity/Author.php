 ...
 *      ),
 *      exclusion = @Hateoas\Exclusion(groups="getAllAuthor")
 * )
 *
 * @Hateoas\Relation(
 *      "delete",
 ...
 *          parameters = { "id" = "expr(object.getId())" },
 *      ),
 *      exclusion = @Hateoas\Exclusion(groups="getAllAuthor", excludeIf = "expr(not is_granted('ROLE_ADMIN'))"),
 * )
 *
 * @Hateoas\Relation(
 *      "update",
...
class Author
{
    ...
    #[Groups(["getBooks", "getAuthor", "getAllAuthor"])]
    private ?int $id = null;
