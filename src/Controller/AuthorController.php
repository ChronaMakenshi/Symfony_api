...
class AuthorController extends AbstractController
{
    ...
    public function getAuthorList(AuthorRepository $authorRepository, SerializerInterface $serializer, Request $request, TagAwareCacheInterface $cache): JsonResponse
    {
        ...
        $jsonAuthorList = $cache->get($idCache, function (ItemInterface $item) use ($authorRepository, $page, $limit, $serializer) {
            ...
            $context = SerializationContext::create()->setGroups(["getAllAuthor"]);
    ...
    public function createAuthor(Request $request, SerializerInterface $serializer, EntityManagerInterface $em, UrlGeneratorInterface $urlGenerator
        , ValidatorInterface             $validator): JsonResponse
    {
        ...
        $jsonBook = $serializer->serialize($author, 'json', ['groups' => 'getAuthor'], ['groups' => 'getAllAuthor']);
    ...
    public function updateAuthor(Request $request, SerializerInterface $serializer, Author $currentAuthor, EntityManagerInterface $em, ValidatorInterface $validator): JsonResponse
    {
        ...
        $currentAuthor->setTitle($newAuthor->getTitle());
        $currentAuthor->setCoverText($newAuthor->getCoverText());
